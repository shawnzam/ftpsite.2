...
class ProjectFilesControllerTest < ActionController::TestCase
  ...
  test "should create project_file" do
    assert_difference('ProjectFile.count') do
      post :create, project_file: { folder: @project_file.folder, name: @project_file.name, project_id: @project_file.project_id, user_id: @project_file.user_id }
    end
  ...
  test "should update project_file" do
    patch :update, id: @project_file, project_file: { folder: @project_file.folder, name: @project_file.name, project_id: @project_file.project_id, user_id: @project_file.user_id }
    assert_redirected_to project_file_path(assigns(:project_file))
  end
